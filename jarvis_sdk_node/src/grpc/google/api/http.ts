...
export const HttpRule = {
  ...
  fromJSON(object: any): HttpRule {
    ...
    if (object.get !== undefined && object.get !== null) {
      message.pattern = { $case: "get", get: String(object.get) };
    }
    if (object.put !== undefined && object.put !== null) {
      message.pattern = { $case: "put", put: String(object.put) };
    }
    if (object.post !== undefined && object.post !== null) {
      message.pattern = { $case: "post", post: String(object.post) };
    }
    if (object.delete !== undefined && object.delete !== null) {
      message.pattern = { $case: "delete", delete: String(object.delete) };
    }
    if (object.patch !== undefined && object.patch !== null) {
      message.pattern = { $case: "patch", patch: String(object.patch) };
    }
  ...
  fromPartial(object: DeepPartial<HttpRule>): HttpRule {
    ...
    if (
      object.pattern?.$case === "get" &&
      object.pattern?.get !== undefined &&
      object.pattern?.get !== null
    ) {
      message.pattern = { $case: "get", get: object.pattern.get };
    }
    if (
      object.pattern?.$case === "put" &&
      object.pattern?.put !== undefined &&
      object.pattern?.put !== null
    ) {
      message.pattern = { $case: "put", put: object.pattern.put };
    }
    if (
      object.pattern?.$case === "post" &&
      object.pattern?.post !== undefined &&
      object.pattern?.post !== null
    ) {
      message.pattern = { $case: "post", post: object.pattern.post };
    }
    if (
      object.pattern?.$case === "delete" &&
      object.pattern?.delete !== undefined &&
      object.pattern?.delete !== null
    ) {
      message.pattern = { $case: "delete", delete: object.pattern.delete };
    }
    if (
      object.pattern?.$case === "patch" &&
      object.pattern?.patch !== undefined &&
      object.pattern?.patch !== null
    ) {
      message.pattern = { $case: "patch", patch: object.pattern.patch };
    }
    if (
      object.pattern?.$case === "custom" &&
      object.pattern?.custom !== undefined &&
      object.pattern?.custom !== null
    ) {
      message.pattern = {
        $case: "custom",
        custom: CustomHttpPattern.fromPartial(object.pattern.custom),
      };
    }
    if (object.body !== undefined && object.body !== null) {
