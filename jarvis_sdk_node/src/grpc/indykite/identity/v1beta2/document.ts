// @generated by protobuf-ts 2.4.0 with parameter long_type_string,client_grpc1,generate_dependencies,// @generated from protobuf file "indykite/identity/v1beta2/document.proto" (package "indykite.identity.v1beta2", syntax proto3),// tslint:disable
//
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.Document
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.DocumentMask
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.Precondition
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.Write
 */
export interface Write {
    ...
    operation: {
         ...
         * Document to write.
         *
         * @generated from protobuf field: indykite.identity.v1beta2.Document update = 1;
         */
        update: Document;
    } | {
        oneofKind: "delete";
         ...
         *
         * @generated from protobuf field: indykite.identity.v1beta2.DocumentTransform transform = 6;
         */
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.DocumentMask update_mask = 3;
     */
     ...
     * This field can be set only when the operation is `update`.
     *
     * @generated from protobuf field: repeated indykite.identity.v1beta2.DocumentTransform.FieldTransform update_transforms = 7;
     */
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.Precondition current_document = 4;
     */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.WriteResult
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.DocumentTransform
 */
export interface DocumentTransform {
     ...
     *
     * @generated from protobuf field: repeated indykite.identity.v1beta2.DocumentTransform.FieldTransform field_transforms = 2;
     */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.DocumentTransform.FieldTransform
 */
...
class Document$Type extends MessageType<Document> {
    constructor() {
        super("indykite.identity.v1beta2.Document", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field indykite.identity.v1beta2.Document.fields");
            }
        }
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.Document
 */
export const Document = new Document$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DocumentMask$Type extends MessageType<DocumentMask> {
    constructor() {
        super("indykite.identity.v1beta2.DocumentMask", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.DocumentMask
 */
export const DocumentMask = new DocumentMask$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Precondition$Type extends MessageType<Precondition> {
    constructor() {
        super("indykite.identity.v1beta2.Precondition", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.Precondition
 */
export const Precondition = new Precondition$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Write$Type extends MessageType<Write> {
    constructor() {
        super("indykite.identity.v1beta2.Write", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Write): Write {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* indykite.identity.v1beta2.Document update */ 1:
                    message.operation = {
                        oneofKind: "update",
    ...
    internalBinaryWrite(message: Write, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* indykite.identity.v1beta2.Document update = 1; */
        ...
        /* indykite.identity.v1beta2.DocumentTransform transform = 6; */
        ...
        /* indykite.identity.v1beta2.DocumentMask update_mask = 3; */
        if (message.updateMask)
            DocumentMask.internalBinaryWrite(message.updateMask, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* repeated indykite.identity.v1beta2.DocumentTransform.FieldTransform update_transforms = 7; */
        ...
        /* indykite.identity.v1beta2.Precondition current_document = 4; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.Write
 */
export const Write = new Write$Type();
// @generated message type with reflection information, may provide speed optimized methods
class WriteResult$Type extends MessageType<WriteResult> {
    constructor() {
        super("indykite.identity.v1beta2.WriteResult", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.WriteResult
 */
export const WriteResult = new WriteResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DocumentTransform$Type extends MessageType<DocumentTransform> {
    constructor() {
        super("indykite.identity.v1beta2.DocumentTransform", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string document */ 1:
                    ...
                    break;
                case /* repeated indykite.identity.v1beta2.DocumentTransform.FieldTransform field_transforms */ 2:
    ...
    internalBinaryWrite(message: DocumentTransform, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated indykite.identity.v1beta2.DocumentTransform.FieldTransform field_transforms = 2; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.DocumentTransform
 */
...
class DocumentTransform_FieldTransform$Type extends MessageType<DocumentTransform_FieldTransform> {
    constructor() {
        super("indykite.identity.v1beta2.DocumentTransform.FieldTransform", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.DocumentTransform.FieldTransform
 */
