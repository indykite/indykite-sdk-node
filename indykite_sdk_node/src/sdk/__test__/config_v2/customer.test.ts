...
describe('readCustomerById', () => {
  describe('when no error is returned', () => {
    ...
    beforeEach(async () => {
      ...
      customer = Customer.deserialize(
        await sdk.readCustomer(ConfigClientV2.newReadCustomerRequest('id', 'customer-id-request')),
      );
    });
  ...
  describe('when an error is returned', () => {
    ...
    beforeEach(async () => {
      ...
      sdk
        .readCustomer(ConfigClientV2.newReadCustomerRequest('id', 'customer-id-request'))
        .catch((err) => {
          thrownError = err;
        });
    });
...
describe('readCustomerByName', () => {
    ...
    beforeEach(async () => {
      ...
      customer = Customer.deserialize(
        await sdk.readCustomer(
          ConfigClientV2.newReadCustomerRequest('name', 'customer-name-request'),
        ),
      );
    });
  ...
  describe('when an error is returned', () => {
    ...
    beforeEach(async () => {
      ...
      sdk
        .readCustomer(ConfigClientV2.newReadCustomerRequest('name', 'customer-name-request'))
        .catch((err) => {
          thrownError = err;
        });
    });
