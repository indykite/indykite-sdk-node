    ...
    describe('when necessary values are sent only', () => {
      beforeEach(async () => {
        application = await sdk.createApplication(
          ConfigClient.newCreateApplicationRequest('app-space-id', 'application-name'),
        );
      });
...
describe('readApplicationById', () => {
    ...
    beforeEach(async () => {
      ...
      application = Application.deserialize(
        await sdk.readApplication(
          ConfigClient.newReadApplicationRequest('id', 'application-id-request'),
        ),
      );
    });
  ...
  describe('when an error is returned', () => {
    ...
    beforeEach(async () => {
      ...
      sdk
        .readApplication(ConfigClient.newReadApplicationRequest('id', 'application-id-request'))
        .catch((err) => {
          thrownError = err;
        });
    });
  ...
  describe('when no error is returned', () => {
    beforeEach(async () => {
      ...
      applications = await new Promise((resolve, reject) => {
        ...
        sdk
          .listApplications(
            ConfigClient.newListApplicationsRequest('app-space-id-request', ['application-name']),
          )
          .on('error', (err) => {
            reject(err);
          })
...
describe('updateApplication', () => {
    ...
    describe('when necessary values are sent only', () => {
      beforeEach(async () => {
        ...
        updatedApplication = await sdk.updateApplication(
          ConfigClient.newUpdateApplicationRequest(application),
        );
      });
  ...
  describe('when a different application is returned', () => {
    ...
    beforeEach(async () => {
      ...
      return sdk
        .updateApplication(ConfigClient.newUpdateApplicationRequest(application))
  ...
  describe('when an error is returned', () => {
    ...
    beforeEach(async () => {
      ...
      sdk.updateApplication(ConfigClient.newUpdateApplicationRequest(application)).catch((err) => {
        thrownError = err;
      });
    });
...
describe('deleteApplication', () => {
  describe('when no error is returned', () => {
    ...
    beforeEach(async () => {
      ...
      returnedValue = await sdk.deleteApplication(
        ConfigClient.newDeleteApplicationRequest(application),
      );
    });
  ...
  describe('when an error is returned', () => {
    ...
    beforeEach(async () => {
      ...
      sdk.deleteApplication(ConfigClient.newDeleteApplicationRequest(application)).catch((err) => {
        thrownError = err;
      });
    });
