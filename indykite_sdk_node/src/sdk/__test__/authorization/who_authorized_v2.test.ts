...
describe('whoAuthorized', () => {
  describe('when the response does not contain an error', () => {
    ...
    beforeEach(async () => {
      ...
      result = await sdk.whoAuthorized(AuthorizationClientV2.newWhoAuthorizedRequest(resources));
    });
  ...
  describe('when the response does not contain any value', () => {
    ...
    beforeEach(async () => {
      ...
      try {
        ...
        await sdk.whoAuthorized(AuthorizationClientV2.newWhoAuthorizedRequest(resources));
      } catch (err) {
        caughtError = err;
      }
    });
