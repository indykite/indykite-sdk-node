...
// @generated from protobuf file "indykite/identity/v1beta1/import.proto" (package "indykite.identity.v1beta1", syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.ImportDigitalTwinsRequest
 */
export interface ImportDigitalTwinsRequest {
    /**
     * @generated from protobuf field: repeated indykite.identity.v1beta1.ImportDigitalTwin entities = 1;
     */
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.ImportDigitalTwinSuccess
 */
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.ImportDigitalTwinResult
 */
export interface ImportDigitalTwinResult {
    ...
    result: {
        oneofKind: "success";
        /**
         * @generated from protobuf field: indykite.identity.v1beta1.ImportDigitalTwinSuccess success = 2;
         */
        success: ImportDigitalTwinSuccess;
    } | {
        oneofKind: "error";
        /**
         * @generated from protobuf field: indykite.identity.v1beta1.ImportDigitalTwinError error = 3;
         */
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.ImportDigitalTwinsResponse
 */
export interface ImportDigitalTwinsResponse {
    /**
     * @generated from protobuf field: repeated indykite.identity.v1beta1.ImportDigitalTwinResult results = 1;
     */
    results: ImportDigitalTwinResult[];
}
/**
 * @generated from protobuf message indykite.identity.v1beta1.ImportDigitalTwin
 */
export interface ImportDigitalTwin {
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta1.PasswordCredential password = 6;
     */
    password?: PasswordCredential;
    /**
     * OAuth2 Identity Provider information to append to the DigitalTwin.
     *
     * @generated from protobuf field: repeated indykite.identity.v1beta1.UserProvider provider_user_info = 7;
     */
    providerUserInfo: UserProvider[];
    /**
     * Import and patch additional properties after the user is imported.
     *
     * @generated from protobuf field: indykite.identity.v1beta1.ImportProperties properties = 8;
     */
    properties?: ImportProperties;
    /**
     * Metadata to preserve with user import - ignored when DigitalTwin already exist.
     *
     * @generated from protobuf field: indykite.identity.v1beta1.UserMetadata metadata = 9;
     */
    metadata?: UserMetadata;
}
/**
 * @generated from protobuf message indykite.identity.v1beta1.ImportProperties
 */
...
class ImportDigitalTwinsRequest$Type extends MessageType<ImportDigitalTwinsRequest> {
    constructor() {
        super("indykite.identity.v1beta1.ImportDigitalTwinsRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ImportDigitalTwinsRequest): ImportDigitalTwinsRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated indykite.identity.v1beta1.ImportDigitalTwin entities */ 1:
    ...
    internalBinaryWrite(message: ImportDigitalTwinsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated indykite.identity.v1beta1.ImportDigitalTwin entities = 1; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.ImportDigitalTwinsRequest
 */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.ImportDigitalTwinSuccess
 */
...
class ImportDigitalTwinError$Type extends MessageType<ImportDigitalTwinError> {
    constructor() {
        super("indykite.identity.v1beta1.ImportDigitalTwinError", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.ImportDigitalTwinError
 */
...
class ImportDigitalTwinResult$Type extends MessageType<ImportDigitalTwinResult> {
    constructor() {
        super("indykite.identity.v1beta1.ImportDigitalTwinResult", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 index */ 1:
                    ...
                    break;
                case /* indykite.identity.v1beta1.ImportDigitalTwinSuccess success */ 2:
                    message.result = {
                        oneofKind: "success",
                        success: ImportDigitalTwinSuccess.internalBinaryRead(reader, reader.uint32(), options, (message.result as any).success)
                    };
                    break;
                case /* indykite.identity.v1beta1.ImportDigitalTwinError error */ 3:
                    message.result = {
                        oneofKind: "error",
    ...
    internalBinaryWrite(message: ImportDigitalTwinResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* indykite.identity.v1beta1.ImportDigitalTwinSuccess success = 2; */
        ...
        /* indykite.identity.v1beta1.ImportDigitalTwinError error = 3; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.ImportDigitalTwinResult
 */
...
class ImportDigitalTwinsResponse$Type extends MessageType<ImportDigitalTwinsResponse> {
    constructor() {
        super("indykite.identity.v1beta1.ImportDigitalTwinsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ImportDigitalTwinsResponse): ImportDigitalTwinsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated indykite.identity.v1beta1.ImportDigitalTwinResult results */ 1:
    ...
    internalBinaryWrite(message: ImportDigitalTwinsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated indykite.identity.v1beta1.ImportDigitalTwinResult results = 1; */
        for (let i = 0; i < message.results.length; i++)
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.ImportDigitalTwinsResponse
 */
...
class ImportDigitalTwin$Type extends MessageType<ImportDigitalTwin> {
    constructor() {
        super("indykite.identity.v1beta1.ImportDigitalTwin", [
            { no: 1, name: "id", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "validate.rules": { bytes: { len: "16", ignoreEmpty: true } } } },
            { no: 2, name: "tenant_id", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "validate.rules": { bytes: { len: "16" } } } },
            { no: 3, name: "kind", kind: "enum", T: () => ["indykite.identity.v1beta1.DigitalTwinKind", DigitalTwinKind, "DIGITAL_TWIN_KIND_"], options: { "validate.rules": { enum: { definedOnly: true, in: [1, 3] } } } },
            { no: 4, name: "state", kind: "enum", T: () => ["indykite.identity.v1beta1.DigitalTwinState", DigitalTwinState, "DIGITAL_TWIN_STATE_"], options: { "validate.rules": { enum: { definedOnly: true, in: [1, 2] } } } },
    ...
    create(value?: PartialMessage<ImportDigitalTwin>): ImportDigitalTwin {
        const message = { id: new Uint8Array(0), tenantId: new Uint8Array(0), kind: 0, state: 0, tags: [], providerUserInfo: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryWrite(message: ImportDigitalTwin, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* indykite.identity.v1beta1.PasswordCredential password = 6; */
        if (message.password)
            PasswordCredential.internalBinaryWrite(message.password, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* repeated indykite.identity.v1beta1.UserProvider provider_user_info = 7; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.ImportDigitalTwin
 */
...
class ImportProperties$Type extends MessageType<ImportProperties> {
    constructor() {
        super("indykite.identity.v1beta1.ImportProperties", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.ImportProperties
 */
