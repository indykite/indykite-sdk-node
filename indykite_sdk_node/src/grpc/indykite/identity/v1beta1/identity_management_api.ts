...
/**
 * @generated from protobuf message indykite.identity.v1beta1.RegisterDigitalTwinWithoutCredentialRequest
 */
export interface RegisterDigitalTwinWithoutCredentialRequest {
    ...
    tenantId: Uint8Array;
    /**
     * @generated from protobuf field: indykite.identity.v1beta1.DigitalTwinKind digital_twin_kind = 1;
     */
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.RegisterDigitalTwinWithoutCredentialResponse
 */
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.IsAuthorizedRequest
 */
export interface IsAuthorizedRequest {
    /**
     * Subject is DigitalTwin identifier to check if is authorized to perform given actions.
     *
     * @generated from protobuf field: indykite.identity.v1beta1.DigitalTwinIdentifier subject = 1;
     */
    subject?: DigitalTwinIdentifier;
    /**
     * A list of resources to authorize against.
     *
     * @generated from protobuf field: repeated indykite.identity.v1beta1.IsAuthorizedRequest.Resource resources = 2;
     */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta1.IsAuthorizedRequest.Resource
 */
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.IsAuthorizedResponse
 */
export interface IsAuthorizedResponse {
     ...
     *
     * @generated from protobuf field: map<string, indykite.identity.v1beta1.AuthorizationDecision> decisions = 2;
     */
    decisions: {
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.AuthorizationDecision
 */
...
/**
 * @generated from protobuf message indykite.identity.v1beta1.EnrichTokenRequest
 */
 ...
 * EnrichTokenResponse ...
 *
 * @generated from protobuf message indykite.identity.v1beta1.EnrichTokenResponse
 */
...
class RegisterDigitalTwinWithoutCredentialRequest$Type extends MessageType<RegisterDigitalTwinWithoutCredentialRequest> {
    constructor() {
        super("indykite.identity.v1beta1.RegisterDigitalTwinWithoutCredentialRequest", [
            { no: 2, name: "tenant_id", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "validate.rules": { bytes: { len: "16" } } } },
            { no: 1, name: "digital_twin_kind", kind: "enum", T: () => ["indykite.identity.v1beta1.DigitalTwinKind", DigitalTwinKind, "DIGITAL_TWIN_KIND_"], options: { "validate.rules": { enum: { definedOnly: true, notIn: [0] } } } },
    ...
    create(value?: PartialMessage<RegisterDigitalTwinWithoutCredentialRequest>): RegisterDigitalTwinWithoutCredentialRequest {
        const message = { tenantId: new Uint8Array(0), digitalTwinKind: 0, digitalTwinTags: [], properties: [], bookmarks: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes tenant_id */ 2:
                    message.tenantId = reader.bytes();
                    break;
                case /* indykite.identity.v1beta1.DigitalTwinKind digital_twin_kind */ 1:
    ...
    internalBinaryWrite(message: RegisterDigitalTwinWithoutCredentialRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* indykite.identity.v1beta1.DigitalTwinKind digital_twin_kind = 1; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.RegisterDigitalTwinWithoutCredentialRequest
 */
...
class RegisterDigitalTwinWithoutCredentialResponse$Type extends MessageType<RegisterDigitalTwinWithoutCredentialResponse> {
    constructor() {
        super("indykite.identity.v1beta1.RegisterDigitalTwinWithoutCredentialResponse", [
            { no: 1, name: "digital_twin", kind: "message", T: () => DigitalTwin },
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.RegisterDigitalTwinWithoutCredentialResponse
 */
...
class IsAuthorizedRequest$Type extends MessageType<IsAuthorizedRequest> {
    constructor() {
        super("indykite.identity.v1beta1.IsAuthorizedRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IsAuthorizedRequest): IsAuthorizedRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* indykite.identity.v1beta1.DigitalTwinIdentifier subject */ 1:
                    message.subject = DigitalTwinIdentifier.internalBinaryRead(reader, reader.uint32(), options, message.subject);
                    break;
                case /* repeated indykite.identity.v1beta1.IsAuthorizedRequest.Resource resources */ 2:
    ...
    internalBinaryWrite(message: IsAuthorizedRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* indykite.identity.v1beta1.DigitalTwinIdentifier subject = 1; */
        if (message.subject)
            DigitalTwinIdentifier.internalBinaryWrite(message.subject, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* repeated indykite.identity.v1beta1.IsAuthorizedRequest.Resource resources = 2; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.IsAuthorizedRequest
 */
...
class IsAuthorizedRequest_Resource$Type extends MessageType<IsAuthorizedRequest_Resource> {
    constructor() {
        super("indykite.identity.v1beta1.IsAuthorizedRequest.Resource", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.IsAuthorizedRequest.Resource
 */
...
class IsAuthorizedResponse$Type extends MessageType<IsAuthorizedResponse> {
    constructor() {
        super("indykite.identity.v1beta1.IsAuthorizedResponse", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.protobuf.Timestamp decision_time */ 1:
                    ...
                    break;
                case /* map<string, indykite.identity.v1beta1.AuthorizationDecision> decisions */ 2:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field indykite.identity.v1beta1.IsAuthorizedResponse.decisions");
            }
        }
    ...
    internalBinaryWrite(message: IsAuthorizedResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* map<string, indykite.identity.v1beta1.AuthorizationDecision> decisions = 2; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.IsAuthorizedResponse
 */
...
class AuthorizationDecision$Type extends MessageType<AuthorizationDecision> {
    constructor() {
        super("indykite.identity.v1beta1.AuthorizationDecision", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.bool();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field indykite.identity.v1beta1.AuthorizationDecision.allow_action");
            }
        }
        map[key ?? ""] = val ?? false;
    }
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.AuthorizationDecision
 */
...
class EnrichTokenRequest$Type extends MessageType<EnrichTokenRequest> {
    constructor() {
        super("indykite.identity.v1beta1.EnrichTokenRequest", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.EnrichTokenRequest
 */
...
class EnrichTokenResponse$Type extends MessageType<EnrichTokenResponse> {
    constructor() {
        super("indykite.identity.v1beta1.EnrichTokenResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta1.EnrichTokenResponse
 */
