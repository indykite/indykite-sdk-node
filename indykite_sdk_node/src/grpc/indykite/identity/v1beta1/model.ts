...
// @generated from protobuf file "indykite/identity/v1beta1/model.proto" (package "indykite.identity.v1beta1", syntax proto3)
// tslint:disable
//
...
class DigitalTwin$Type extends MessageType<DigitalTwin> {
    ...
    create(value?: PartialMessage<DigitalTwin>): DigitalTwin {
        const message = { id: new Uint8Array(0), tenantId: new Uint8Array(0), kind: 0, state: 0, tags: [] };
