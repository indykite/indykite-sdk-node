...
export interface IIdentityManagementAPIClient {
     ...
     *
     * @generated from protobuf rpc: ImportDigitalTwins(indykite.identity.v1beta1.ImportDigitalTwinsRequest) returns (indykite.identity.v1beta1.ImportDigitalTwinsResponse);
     */
     ...
     * This is a protected operation and it can be accessed only with valid agent credentials!
     *
     * @generated from protobuf rpc: RegisterDigitalTwinWithoutCredential(indykite.identity.v1beta1.RegisterDigitalTwinWithoutCredentialRequest) returns (indykite.identity.v1beta1.RegisterDigitalTwinWithoutCredentialResponse);
     */
