// @generated by protobuf-ts 2.4.0 with parameter long_type_string,client_grpc1,generate_dependencies,// @generated from protobuf file "indykite/identity/v1beta2/attributes.proto" (package "indykite.identity.v1beta2", syntax proto3),// tslint:disable
//
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.PropertyDefinition
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.PropertyConstraint
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.PropertyMask
 */
export interface PropertyMask {
    /**
     * @generated from protobuf field: indykite.identity.v1beta2.PropertyDefinition definition = 1;
     */
...
export interface PropertyMetadata {
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.AssuranceLevel assurance_level = 2;
     */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.Property
 */
export interface Property {
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.PropertyDefinition definition = 2;
     */
    definition?: PropertyDefinition;
    /**
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.PropertyMetadata meta = 3;
     */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.PropertyBatchOperation
 */
export interface PropertyBatchOperation {
    ...
    operation: {
        oneofKind: "add";
        /**
         * @generated from protobuf field: indykite.identity.v1beta2.Property add = 1;
         */
        add: Property;
    } | {
        oneofKind: "replace";
        /**
         * @generated from protobuf field: indykite.identity.v1beta2.Property replace = 2;
         */
        replace: Property;
    } | {
        oneofKind: "remove";
        /**
         * @generated from protobuf field: indykite.identity.v1beta2.Property remove = 3;
         */
        remove: Property;
    } | {
        oneofKind: undefined;
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.BatchOperationResult
 */
export interface BatchOperationResult {
    ...
    result: {
        oneofKind: "success";
        /**
         * @generated from protobuf field: indykite.identity.v1beta2.BatchOperationResultSuccess success = 5;
         */
        success: BatchOperationResultSuccess;
    } | {
        oneofKind: "error";
        /**
         * @generated from protobuf field: indykite.identity.v1beta2.BatchOperationResultError error = 6;
         */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.BatchOperationResultSuccess
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.BatchOperationResultError
 */
 ...
 *
 * @generated from protobuf enum indykite.identity.v1beta2.AssuranceLevel
 */
...
class Schema$Type extends MessageType<Schema> {
    constructor() {
        super("indykite.identity.v1beta2.Schema", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field indykite.identity.v1beta2.Schema.context");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.Schema
 */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.PropertyDefinition
 */
...
class PropertyConstraint$Type extends MessageType<PropertyConstraint> {
    constructor() {
        super("indykite.identity.v1beta2.PropertyConstraint", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.PropertyConstraint
 */
export const PropertyConstraint = new PropertyConstraint$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PropertyMask$Type extends MessageType<PropertyMask> {
    constructor() {
        super("indykite.identity.v1beta2.PropertyMask", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PropertyMask): PropertyMask {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* indykite.identity.v1beta2.PropertyDefinition definition */ 1:
                    message.definition = PropertyDefinition.internalBinaryRead(reader, reader.uint32(), options, message.definition);
                    break;
                case /* indykite.identity.v1beta2.PropertyConstraint constraint */ 2:
...
class PropertyMetadata$Type extends MessageType<PropertyMetadata> {
    constructor() {
        super("indykite.identity.v1beta2.PropertyMetadata", [
            { no: 1, name: "primary", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "assurance_level", kind: "enum", T: () => ["indykite.identity.v1beta2.AssuranceLevel", AssuranceLevel, "ASSURANCE_LEVEL_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool primary */ 1:
                    ...
                    break;
                case /* indykite.identity.v1beta2.AssuranceLevel assurance_level */ 2:
    ...
    internalBinaryWrite(message: PropertyMetadata, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* indykite.identity.v1beta2.AssuranceLevel assurance_level = 2; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.PropertyMetadata
 */
export const PropertyMetadata = new PropertyMetadata$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Property$Type extends MessageType<Property> {
    constructor() {
        super("indykite.identity.v1beta2.Property", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    ...
                    break;
                case /* indykite.identity.v1beta2.PropertyDefinition definition */ 2:
                    message.definition = PropertyDefinition.internalBinaryRead(reader, reader.uint32(), options, message.definition);
                    break;
                case /* indykite.identity.v1beta2.PropertyMetadata meta */ 3:
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.Property
 */
export const Property = new Property$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PropertyBatchOperation$Type extends MessageType<PropertyBatchOperation> {
    constructor() {
        super("indykite.identity.v1beta2.PropertyBatchOperation", [
    ...
    internalBinaryWrite(message: PropertyBatchOperation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* indykite.identity.v1beta2.Property add = 1; */
        ...
        /* indykite.identity.v1beta2.Property replace = 2; */
        ...
        /* indykite.identity.v1beta2.Property remove = 3; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.PropertyBatchOperation
 */
...
class BatchOperationResult$Type extends MessageType<BatchOperationResult> {
    constructor() {
        super("indykite.identity.v1beta2.BatchOperationResult", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 index */ 4:
                    ...
                    break;
                case /* indykite.identity.v1beta2.BatchOperationResultSuccess success */ 5:
                    message.result = {
                        oneofKind: "success",
                        success: BatchOperationResultSuccess.internalBinaryRead(reader, reader.uint32(), options, (message.result as any).success)
                    };
                    break;
                case /* indykite.identity.v1beta2.BatchOperationResultError error */ 6:
                    message.result = {
                        oneofKind: "error",
    ...
    internalBinaryWrite(message: BatchOperationResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* indykite.identity.v1beta2.BatchOperationResultSuccess success = 5; */
        ...
        /* indykite.identity.v1beta2.BatchOperationResultError error = 6; */
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.BatchOperationResult
 */
...
class BatchOperationResultSuccess$Type extends MessageType<BatchOperationResultSuccess> {
    constructor() {
        super("indykite.identity.v1beta2.BatchOperationResultSuccess", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.BatchOperationResultSuccess
 */
...
class BatchOperationResultError$Type extends MessageType<BatchOperationResultError> {
    constructor() {
        super("indykite.identity.v1beta2.BatchOperationResultError", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.BatchOperationResultError
 */
