// @generated by protobuf-ts 2.4.0 with parameter long_type_string,client_grpc1,generate_dependencies,// @generated from protobuf file "indykite/identity/v1beta2/model.proto" (package "indykite.identity.v1beta2", syntax proto3),// tslint:disable
//
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.DigitalTwin
 */
...
/**
 * @generated from protobuf message indykite.identity.v1beta2.DigitalEntity
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.ErrorMessage
 */
export interface ErrorMessage {
    /**
     * @generated from protobuf field: indykite.identity.v1beta2.ErrorCode code = 1;
     */
    code: ErrorCode;
    /**
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.Invitation
 */
export interface Invitation {
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.DigitalTwin accepted_by = 8;
     */
    acceptedBy?: DigitalTwin;
    /**
     * State describe current state of workflow
     *
     * @generated from protobuf field: indykite.identity.v1beta2.InvitationState state = 9;
     */
 ...
 * among others.
 *
 * @generated from protobuf message indykite.identity.v1beta2.WellKnown
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.OAuth2TokenResponse
 */
...
/**
 * @generated from protobuf message indykite.identity.v1beta2.FlushInactiveOAuth2TokensRequest
 */
...
/**
 * @generated from protobuf message indykite.identity.v1beta2.IdentityTokenInfo
 */
export interface IdentityTokenInfo {
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.DigitalTwin subject = 4;
     */
    subject?: DigitalTwin;
    /**
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.DigitalTwin impersonated = 5;
     */
     ...
     *
     * @generated from protobuf field: repeated indykite.identity.v1beta2.ProviderInfo provider_info = 9;
     */
...
export interface ProviderInfo {
     ...
     *
     * @generated from protobuf field: indykite.identity.v1beta2.ProviderType type = 1;
     */
    type: ProviderType;
    /**
...
/**
 * @generated from protobuf message indykite.identity.v1beta2.UserInfoResponsePayload
 */
 ...
 *
 * @generated from protobuf message indykite.identity.v1beta2.PostalAddress
 */
 ...
 *
 * @generated from protobuf enum indykite.identity.v1beta2.DigitalTwinState
 */
 ...
 *
 * @generated from protobuf enum indykite.identity.v1beta2.DigitalTwinKind
 */
...
/**
 * @generated from protobuf enum indykite.identity.v1beta2.ErrorCode
 */
...
/**
 * @generated from protobuf enum indykite.identity.v1beta2.InvitationState
 */
...
class DigitalTwin$Type extends MessageType<DigitalTwin> {
    constructor() {
        super("indykite.identity.v1beta2.DigitalTwin", [
            ...
            { no: 3, name: "kind", kind: "enum", T: () => ["indykite.identity.v1beta2.DigitalTwinKind", DigitalTwinKind, "DIGITAL_TWIN_KIND_"], options: { "validate.rules": { enum: { definedOnly: true } } } },
            { no: 4, name: "state", kind: "enum", T: () => ["indykite.identity.v1beta2.DigitalTwinState", DigitalTwinState, "DIGITAL_TWIN_STATE_"], options: { "validate.rules": { enum: { definedOnly: true } } } },
    ...
    create(value?: PartialMessage<DigitalTwin>): DigitalTwin {
        const message = { id: "", tenantId: "", kind: 0, state: 0, tags: [] };
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.DigitalTwin
 */
export const DigitalTwin = new DigitalTwin$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DigitalEntity$Type extends MessageType<DigitalEntity> {
    constructor() {
        super("indykite.identity.v1beta2.DigitalEntity", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.DigitalEntity
 */
...
class ErrorMessage$Type extends MessageType<ErrorMessage> {
    constructor() {
        super("indykite.identity.v1beta2.ErrorMessage", [
            { no: 1, name: "code", kind: "enum", T: () => ["indykite.identity.v1beta2.ErrorCode", ErrorCode, "ERROR_CODE_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ErrorMessage): ErrorMessage {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* indykite.identity.v1beta2.ErrorCode code */ 1:
    ...
    internalBinaryWrite(message: ErrorMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* indykite.identity.v1beta2.ErrorCode code = 1; */
        if (message.code !== 0)
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.ErrorMessage
 */
export const ErrorMessage = new ErrorMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Invitation$Type extends MessageType<Invitation> {
    constructor() {
        super("indykite.identity.v1beta2.Invitation", [
            ...
            { no: 9, name: "state", kind: "enum", T: () => ["indykite.identity.v1beta2.InvitationState", InvitationState, "INVITATION_STATE_"] },
    ...
    create(value?: PartialMessage<Invitation>): Invitation {
        const message = { tenantId: "", referenceId: "", state: 0, invitee: { oneofKind: undefined } };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* indykite.objects.v1beta1.MapValue message_attributes */ 5:
                    ...
                    break;
                case /* indykite.identity.v1beta2.DigitalTwin accepted_by */ 8:
                    message.acceptedBy = DigitalTwin.internalBinaryRead(reader, reader.uint32(), options, message.acceptedBy);
                    break;
                case /* indykite.identity.v1beta2.InvitationState state */ 9:
                    message.state = reader.int32();
                    break;
                case /* string email */ 6:
                    message.invitee = {
    ...
    internalBinaryWrite(message: Invitation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* indykite.identity.v1beta2.DigitalTwin accepted_by = 8; */
        ...
        /* indykite.identity.v1beta2.InvitationState state = 9; */
        if (message.state !== 0)
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.Invitation
 */
export const Invitation = new Invitation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class WellKnown$Type extends MessageType<WellKnown> {
    constructor() {
        super("indykite.identity.v1beta2.WellKnown", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.WellKnown
 */
export const WellKnown = new WellKnown$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OAuth2TokenResponse$Type extends MessageType<OAuth2TokenResponse> {
    constructor() {
        super("indykite.identity.v1beta2.OAuth2TokenResponse", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.OAuth2TokenResponse
 */
...
class FlushInactiveOAuth2TokensRequest$Type extends MessageType<FlushInactiveOAuth2TokensRequest> {
    constructor() {
        super("indykite.identity.v1beta2.FlushInactiveOAuth2TokensRequest", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.FlushInactiveOAuth2TokensRequest
 */
...
class IdentityTokenInfo$Type extends MessageType<IdentityTokenInfo> {
    constructor() {
        super("indykite.identity.v1beta2.IdentityTokenInfo", [
    ...
    create(value?: PartialMessage<IdentityTokenInfo>): IdentityTokenInfo {
        const message = { customerId: "", appSpaceId: "", applicationId: "", providerInfo: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string application_id */ 3:
                    ...
                    break;
                case /* indykite.identity.v1beta2.DigitalTwin subject */ 4:
                    message.subject = DigitalTwin.internalBinaryRead(reader, reader.uint32(), options, message.subject);
                    break;
                case /* indykite.identity.v1beta2.DigitalTwin impersonated */ 5:
                ...
                case /* google.protobuf.Timestamp authentication_time */ 8:
                    ...
                    break;
                case /* repeated indykite.identity.v1beta2.ProviderInfo provider_info */ 9:
    ...
    internalBinaryWrite(message: IdentityTokenInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated indykite.identity.v1beta2.ProviderInfo provider_info = 9; */
...
class ProviderInfo$Type extends MessageType<ProviderInfo> {
    constructor() {
        super("indykite.identity.v1beta2.ProviderInfo", [
            { no: 1, name: "type", kind: "enum", T: () => ["indykite.identity.v1beta2.ProviderType", ProviderType, "PROVIDER_TYPE_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ProviderInfo): ProviderInfo {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* indykite.identity.v1beta2.ProviderType type */ 1:
    ...
    internalBinaryWrite(message: ProviderInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* indykite.identity.v1beta2.ProviderType type = 1; */
        if (message.type !== 0)
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.ProviderInfo
 */
...
class UserInfoResponsePayload$Type extends MessageType<UserInfoResponsePayload> {
    constructor() {
        super("indykite.identity.v1beta2.UserInfoResponsePayload", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.UserInfoResponsePayload
 */
...
class PostalAddress$Type extends MessageType<PostalAddress> {
    constructor() {
        super("indykite.identity.v1beta2.PostalAddress", [
...
/**
 * @generated MessageType for protobuf message indykite.identity.v1beta2.PostalAddress
 */
