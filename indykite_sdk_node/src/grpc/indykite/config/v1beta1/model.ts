...
class ApplicationAgent$Type extends MessageType<ApplicationAgent> {
    ...
    create(value?: PartialMessage<ApplicationAgent>): ApplicationAgent {
        const message = { id: "", name: "", displayName: "", createdBy: "", updatedBy: "", etag: "", customerId: "", appSpaceId: "", applicationId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class ConfigNode$Type extends MessageType<ConfigNode> {
    ...
    create(value?: PartialMessage<ConfigNode>): ConfigNode {
        const message = { id: "", name: "", displayName: "", createdBy: "", updatedBy: "", etag: "", customerId: "", appSpaceId: "", tenantId: "", config: { oneofKind: undefined } };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
