...
// @generated from protobuf file "indykite/ingest/v1beta2/model.proto" (package "indykite.ingest.v1beta2", syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message indykite.ingest.v1beta2.Info
 */
export interface Info {
    /**
     * @generated from protobuf field: repeated indykite.ingest.v1beta2.Change changes = 1;
     */
    changes: Change[];
}
/**
 * @generated from protobuf message indykite.ingest.v1beta2.Change
 */
export interface Change {
    ...
    id: string;
    /**
     * @generated from protobuf field: indykite.ingest.v1beta2.Change.DataType data_type = 2;
     */
    dataType: Change_DataType;
}
/**
 * @generated from protobuf enum indykite.ingest.v1beta2.Change.DataType
 */
export enum Change_DataType {
    /**
     * @generated from protobuf enum value: DATA_TYPE_INVALID = 0;
     */
    INVALID = 0,
    /**
     * @generated from protobuf enum value: DATA_TYPE_DIGITAL_TWIN = 1;
     */
    DIGITAL_TWIN = 1,
    /**
     * @generated from protobuf enum value: DATA_TYPE_RESOURCE = 2;
     */
    RESOURCE = 2,
    /**
     * @generated from protobuf enum value: DATA_TYPE_RELATION = 3;
     */
    RELATION = 3
}
...
class Info$Type extends MessageType<Info> {
    constructor() {
        super("indykite.ingest.v1beta2.Info", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Info): Info {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated indykite.ingest.v1beta2.Change changes */ 1:
    ...
    internalBinaryWrite(message: Info, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated indykite.ingest.v1beta2.Change changes = 1; */
...
/**
 * @generated MessageType for protobuf message indykite.ingest.v1beta2.Info
 */
export const Info = new Info$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Change$Type extends MessageType<Change> {
    constructor() {
        super("indykite.ingest.v1beta2.Change", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "data_type", kind: "enum", T: () => ["indykite.ingest.v1beta2.Change.DataType", Change_DataType, "DATA_TYPE_"] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    message.id = reader.string();
                    break;
                case /* indykite.ingest.v1beta2.Change.DataType data_type */ 2:
    ...
    internalBinaryWrite(message: Change, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* indykite.ingest.v1beta2.Change.DataType data_type = 2; */
...
/**
 * @generated MessageType for protobuf message indykite.ingest.v1beta2.Change
 */
