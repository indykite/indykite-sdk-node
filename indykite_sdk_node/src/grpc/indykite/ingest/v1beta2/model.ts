...
import { DigitalTwinKind } from "../../identity/v1beta2/model";
/**
...
export interface DeleteData {
    ...
    data: {
        oneofKind: "node";
        /**
         * in the delete cypher, return IsDigitalTwin of the node, so that we can also delete from Identity Graph
         *
...
export interface DigitalTwin {
    ...
    tags: string[];
    /**
     * @generated from protobuf field: indykite.identity.v1beta2.DigitalTwinKind kind = 4;
     */
...
class DigitalTwin$Type extends MessageType<DigitalTwin> {
    constructor() {
        super("indykite.ingest.v1beta2.DigitalTwin", [
            ...
            { no: 4, name: "kind", kind: "enum", T: () => ["indykite.identity.v1beta2.DigitalTwinKind", DigitalTwinKind, "DIGITAL_TWIN_KIND_"], options: { "validate.rules": { enum: { definedOnly: true, notIn: [0] } } } },
    ...
    create(value?: PartialMessage<DigitalTwin>): DigitalTwin {
        const message = { externalId: "", type: "", tags: [], kind: 0, tenantId: "", identityProperties: [], properties: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated string tags */ 3:
                    ...
                    break;
                case /* indykite.identity.v1beta2.DigitalTwinKind kind */ 4:
    ...
    internalBinaryWrite(message: DigitalTwin, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* indykite.identity.v1beta2.DigitalTwinKind kind = 4; */
        if (message.kind !== 0)
