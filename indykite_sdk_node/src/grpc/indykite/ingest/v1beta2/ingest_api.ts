// @generated by protobuf-ts 2.4.0 with parameter long_type_string,client_grpc1,generate_dependencies,// @generated from protobuf file "indykite/ingest/v1beta2/ingest_api.proto" (package "indykite.ingest.v1beta2", syntax proto3),// tslint:disable
//
...
/**
 * @generated from protobuf message indykite.ingest.v1beta2.StreamRecordsRequest
 */
export interface StreamRecordsRequest {
    /**
     * @generated from protobuf field: indykite.ingest.v1beta2.Record record = 1;
     */
    record?: Record;
}
/**
 * @generated from protobuf message indykite.ingest.v1beta2.StreamRecordsResponse
 */
export interface StreamRecordsResponse {
    ...
    error: {
        ...
        /**
         * @generated from protobuf field: indykite.ingest.v1beta2.RecordError record_error = 3;
         */
...
/**
 * @generated from protobuf message indykite.ingest.v1beta2.IngestRecordRequest
 */
...
/**
 * @generated from protobuf message indykite.ingest.v1beta2.IngestRecordResponse
 */
export interface IngestRecordResponse {
    /**
     * @generated from protobuf field: indykite.ingest.v1beta2.RecordError record_error = 1;
     */
    recordError?: RecordError;
}
...
class StreamRecordsRequest$Type extends MessageType<StreamRecordsRequest> {
    constructor() {
        super("indykite.ingest.v1beta2.StreamRecordsRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StreamRecordsRequest): StreamRecordsRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* indykite.ingest.v1beta2.Record record */ 1:
    ...
    internalBinaryWrite(message: StreamRecordsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* indykite.ingest.v1beta2.Record record = 1; */
        if (message.record)
...
/**
 * @generated MessageType for protobuf message indykite.ingest.v1beta2.StreamRecordsRequest
 */
...
class StreamRecordsResponse$Type extends MessageType<StreamRecordsResponse> {
    constructor() {
        super("indykite.ingest.v1beta2.StreamRecordsResponse", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 record_index */ 2:
                    ...
                    break;
                case /* indykite.ingest.v1beta2.RecordError record_error */ 3:
                    message.error = {
                        oneofKind: "recordError",
    ...
    internalBinaryWrite(message: StreamRecordsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* indykite.ingest.v1beta2.RecordError record_error = 3; */
...
/**
 * @generated MessageType for protobuf message indykite.ingest.v1beta2.StreamRecordsResponse
 */
...
class IngestRecordRequest$Type extends MessageType<IngestRecordRequest> {
    constructor() {
        super("indykite.ingest.v1beta2.IngestRecordRequest", [
            { no: 1, name: "record", kind: "message", T: () => Record, options: { "validate.rules": { message: { required: true } } } }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message indykite.ingest.v1beta2.IngestRecordRequest
 */
...
class IngestRecordResponse$Type extends MessageType<IngestRecordResponse> {
    constructor() {
        super("indykite.ingest.v1beta2.IngestRecordResponse", [
            { no: 1, name: "record_error", kind: "message", T: () => RecordError }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IngestRecordResponse): IngestRecordResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* indykite.ingest.v1beta2.RecordError record_error */ 1:
    ...
    internalBinaryWrite(message: IngestRecordResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* indykite.ingest.v1beta2.RecordError record_error = 1; */
        if (message.recordError)
            RecordError.internalBinaryWrite(message.recordError, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message indykite.ingest.v1beta2.IngestRecordResponse
 */
export const IngestRecordResponse = new IngestRecordResponse$Type();
/**
 * @generated ServiceType for protobuf service indykite.ingest.v1beta2.IngestAPI
 */
export const IngestAPI = new ServiceType("indykite.ingest.v1beta2.IngestAPI", [
